...
The `create-archive` action creates a `zip`, `tar`, or `tar.gz` archive of a target directory or file, with support for compression levels and optional automatic uploading as a GitHub Actions workflow artifact.
