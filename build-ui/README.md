...
A reusable GitHub Action that builds a UI project using npm, pnpm, or npx. It automatically detects the package manager based on lock files if not specified.
